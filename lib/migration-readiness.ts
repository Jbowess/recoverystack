...
const REQUIRED_TABLES: RequiredTable[] = [
  ...
  { table: 'product_specs', migration: '0031_information_gathering_tables.sql' },
  { table: 'page_conversion_aggregates', migration: '0032_tier1_tier2_tier3_tables.sql' },
  { table: 'distribution_assets', migration: '0037_distribution_engine.sql' },
  { table: 'outreach_queue', migration: '0037_distribution_engine.sql' },
  { table: 'email_digest_issues', migration: '0037_distribution_engine.sql' },
  { table: 'distribution_asset_metrics', migration: '0037_distribution_engine.sql' },
  { table: 'partner_contacts', migration: '0039_growth_execution_engine.sql' },
  { table: 'channel_publication_queue', migration: '0039_growth_execution_engine.sql' },
  { table: 'social_channel_metrics', migration: '0039_growth_execution_engine.sql' },
  { table: 'editorial_trust_profiles', migration: '0039_growth_execution_engine.sql' },
  { table: 'growth_roadmap_items', migration: '0039_growth_execution_engine.sql' },
  { table: 'product_truth_cards', migration: '0039_growth_execution_engine.sql' },
  { table: 'serp_snapshot_history', migration: '0040_growth_moat_systems.sql' },
  { table: 'competitor_page_snapshots', migration: '0040_growth_moat_systems.sql' },
  { table: 'community_topic_mentions', migration: '0040_growth_moat_systems.sql' },
  { table: 'creator_relationships', migration: '0040_growth_moat_systems.sql' },
  { table: 'outreach_reply_log', migration: '0040_growth_moat_systems.sql' },
  { table: 'conversion_experiments', migration: '0040_growth_moat_systems.sql' },
  { table: 'audience_segments', migration: '0040_growth_moat_systems.sql' },
  { table: 'brand_voice_profiles', migration: '0040_growth_moat_systems.sql' },
  { table: 'automation_policies', migration: '0040_growth_moat_systems.sql' },
  { table: 'pipeline_retry_jobs', migration: '0040_growth_moat_systems.sql' },
  { table: 'lead_magnet_offers', migration: '0040_growth_moat_systems.sql' },
  { table: 'tool_usage_events', migration: '0040_growth_moat_systems.sql' },
  ...
  { table: 'source_watchlists', migration: '0032_editorial_intelligence_ops.sql' },
  { table: 'source_watchlist_hits', migration: '0032_editorial_intelligence_ops.sql' },
  { table: 'page_claims', migration: '0032_editorial_intelligence_ops.sql' },
  { table: 'claim_evidence_links', migration: '0032_editorial_intelligence_ops.sql' },
  { table: 'story_followup_jobs', migration: '0032_editorial_intelligence_ops.sql' },
  { table: 'comparison_dataset_snapshots', migration: '0032_editorial_intelligence_ops.sql' },
  { table: 'source_quality_scores', migration: '0032_editorial_intelligence_ops.sql' },
