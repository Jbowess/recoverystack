...
const phases: Phase[] = [
  ...
  },
  {
    label: 'Distribution',
    steps: [
      { id: 'brand-framework-seeder', name: 'Brand framework seeder', script: 'scripts/brand-framework-seeder.ts' },
      { id: 'rapid-response-engine', name: 'Rapid response engine', script: 'scripts/rapid-response-engine.ts' },
      { id: 'distribution-asset-generator', name: 'Distribution asset generator', script: 'scripts/distribution-asset-generator.ts' },
      { id: 'repurposing-packet-generator', name: 'Repurposing packet generator', script: 'scripts/repurposing-packet-generator.ts' },
      { id: 'signature-visual-generator', name: 'Signature visual generator', script: 'scripts/signature-visual-generator.ts' },
      { id: 'series-generator', name: 'Series generator', script: 'scripts/series-generator.ts' },
      { id: 'lead-magnet-generator', name: 'Lead magnet generator', script: 'scripts/lead-magnet-generator.ts' },
      { id: 'community-prompt-generator', name: 'Community prompt generator', script: 'scripts/community-prompt-generator.ts' },
      { id: 'video-package-generator', name: 'Video package generator', script: 'scripts/video-package-generator.ts' },
      { id: 'brand-landing-loop-builder', name: 'Brand landing loop builder', script: 'scripts/brand-landing-loop-builder.ts' },
      { id: 'creator-brief-generator', name: 'Creator brief generator', script: 'scripts/creator-brief-generator.ts' },
      { id: 'press-data-brief-generator', name: 'Press data brief generator', script: 'scripts/press-data-brief-generator.ts' },
      { id: 'persona-distributor-distribution', name: 'Persona distributor', script: 'scripts/persona-distributor.ts' },
      { id: 'reach-amplifier', name: 'Reach amplifier', script: 'scripts/reach-amplifier.ts' },
      { id: 'winner-campaign-builder', name: 'Winner campaign builder', script: 'scripts/winner-campaign-builder.ts' },
      ...
      { id: 'brand-memory-sync', name: 'Brand memory sync', script: 'scripts/brand-memory-sync.ts' },
      { id: 'narrative-control-sync', name: 'Narrative control sync', script: 'scripts/narrative-control-sync.ts' },
      { id: 'influence-graph-sync', name: 'Influence graph sync', script: 'scripts/influence-graph-sync.ts' },
  ...
  },
  {
    ...
    steps: [
      ...
      { id: 'repurposing-learning-rollup', name: 'Repurposing learning rollup', script: 'scripts/repurposing-learning-rollup.ts' },
      { id: 'repurposing-priority-scorer', name: 'Repurposing priority scorer', script: 'scripts/repurposing-priority-scorer.ts' },
      { id: 'brand-reach-rollup', name: 'Brand reach rollup', script: 'scripts/brand-reach-rollup.ts' },
      { id: 'share-of-voice-rollup', name: 'Share of voice rollup', script: 'scripts/share-of-voice-rollup.ts' },
      { id: 'campaign-portfolio-manager', name: 'Campaign portfolio manager', script: 'scripts/campaign-portfolio-manager.ts' },
      { id: 'executive-attribution-rollup', name: 'Executive attribution rollup', script: 'scripts/executive-attribution-rollup.ts' },
      { id: 'moat-engine-rollup', name: 'Moat engine rollup', script: 'scripts/moat-engine-rollup.ts' },
      { id: 'brand-risk-monitor', name: 'Brand risk monitor', script: 'scripts/brand-risk-monitor.ts' },
      { id: 'tool-idea-miner', name: 'Tool idea miner', script: 'scripts/tool-idea-miner.ts' },
      { id: 'repurposing-feedback-loop', name: 'Repurposing feedback loop', script: 'scripts/repurposing-feedback-loop.ts' },
